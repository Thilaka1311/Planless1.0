-- ============================================================================
-- Migration: Reset participant role to PARTICIPANT on leave_plan
-- Description: Ensures that when an Additional Host leaves a plan via leave_plan RPC,
--              their plan_participants.role is updated to PARTICIPANT so they immediately
--              lose the HOST role and host permissions.
-- ============================================================================
...
BEGIN
  ...
  -- 3. Security Check: Creator host cannot leave their own plan
