...
- Name: plan-completion.spec.ts >> Plan Completion Creates Memory >> should complete Movies plan and verify memory database records
- Location: tests/plan-completion.spec.ts:301:3
