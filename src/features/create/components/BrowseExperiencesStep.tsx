  ...
  return (
    <div className="space-y-5 animate-fade-in text-left">
      <div className="space-y-1">
        <h2 className="text-xl font-display font-black text-zinc-100 tracking-tight">Create Plans</h2>
        <p className="text-xs text-zinc-500">Pick a template or build from scratch.</p>
      </div>

      {/* Suggested Plans Header & Category Fast Filter Selector */}
                ...
                >
                  ...
                  <div className="z-10 space-y-3 mt-auto text-left">
                    ...
                    <div className="w-full bg-white/5 hover:bg-white/10 backdrop-blur-md border border-white/10 text-white font-medium text-[10px] py-2 px-3 rounded-xl flex items-center justify-between transition-colors shadow-inner">
                      <span className="font-mono">Fill in timings</span>
      ...
      <div className="flex items-center gap-2.5 py-1">
        ...
        <span className="text-[8px] font-mono uppercase tracking-widest text-[#ff8b66]/50">Or create a custom plan</span>
        <div className="h-[1px] bg-zinc-900 flex-1" />
      </div>
        ...
        <div className="flex gap-4 items-center">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-1.5">
              <span className="text-[8px] font-mono tracking-widest text-[#ff8b66] uppercase font-bold bg-[#ff8b66]/10 px-2 py-0.5 rounded-full border border-[#ff8b66]/15">Custom</span>
            ...
            <p className="text-[10px] text-zinc-500 leading-normal mt-0.5">Define your own activity name, venue, and timings</p>
          </div>
